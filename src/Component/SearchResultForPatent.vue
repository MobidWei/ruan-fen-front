...
<!--                    </div>-->
                ...
                <div class="filter__se__rf  flex align-center">
                    <span>排序：<span class="pointer" :class="{'active':searchParams.patentId !== ''}"
                                     @click="handleFilter('patentId')">相关度<el-icon v-if="searchParams.patentId ===1"><Bottom/></el-icon><el-icon
                            v-if="searchParams.patentId ===2"><Top/></el-icon></span></span>
                    <span class="m-l-20 pointer" :class="{'active':searchParams.applicationDate !== ''}"
                          @click="handleFilter('applicationDate')">申请日期<el-icon v-if="searchParams.applicationDate ===1"><Bottom/></el-icon><el-icon
                            v-if="searchParams.applicationDate ===2"><Top/></el-icon></span>
...
<!--&lt;!&ndash;                    <span class="m-l-20 pointer" :class="{'active':searchParams.type !== ''}"&ndash;&gt;-->
<!--&lt;!&ndash;                          @click="handleFilter('type')">综合<el-icon v-if="searchParams.type ===1"><Bottom/></el-icon><el-icon&ndash;&gt;-->
<!--&lt;!&ndash;                            v-if="searchParams.type ===2"><Top/></el-icon></span>&ndash;&gt;-->
