<template>
    <div class="wrap">
        <HeaderNavForArticle :page="currentPage" :field="field" :question="question" @sendData="handleData"
                   @requestSearch="handleSearchRequest"/>
        <SearchResultForArticle :question="sharedData" :page="currentPage" :articles="articleList" :count="count" @update-sort="updateSort"/>
...
import HeaderNavForArticle from "@/Component/HeaderNavForArticle.vue";
import SearchResultForArticle from "@/Component/SearchResultForArticle.vue";
